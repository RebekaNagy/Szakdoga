...
helpCalculate program conditions =    
    case (fst(fst prepared)) of
        [EnvError] -> "A parser vagy deparser helytelen, így nem sikerült a környezetek megfelelő generálása.:" 
        _ -> case (snd prepared) of
            ...
            _ -> case sidecons of
                ...
                _ -> "NOERROR::" ++ envListToString (verifyP4 (fst (fst prepared)) (snd prepared) sidecons)
