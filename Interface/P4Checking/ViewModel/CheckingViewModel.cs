...
{
    class CheckingViewModel : ViewModelBase
    {
        private CheckingModel Model;
        ...
        public CheckingViewModel(CheckingModel model)
        {
            Model = model;
        ...
        private void MakeGraph()
        {
            ...
            {
                ErrorMessage = "A gráf kirajzolása előtt ellenőrizze a programot!";
                ErrorBorder = 3;
            }
            else
            {
